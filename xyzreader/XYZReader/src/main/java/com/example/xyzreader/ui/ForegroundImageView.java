...
/**
 * I took this class from Unsplash sample (https://github.com/udacity/ud862-samples).
 * As far as I understand its purpose is to draw (for example for ripple effect) upon the image and
 * it just delegates methods from the imageview to the drawable. Still it looks too massive for such
 * simple purpose.
 */
